...
- Optimized catch-only model (OCOM) from Zhou et al. 2017; see `?ocom`
...
Zhou S, Punt AE, Ye Y, Ellis N, Dichmont CM, Haddon M, Smith DC, Smith ADM (2017) Estimating stock depletion level from patterns of catch history. Fish & Fisheries 18(4): 742-751.
